...
var Async = _react2['default'].createClass({
	...
	propTypes: {
		...
		resetOnFocus: _react2['default'].PropTypes.bool, // resetOnFocus controls whether options are reset when user focuses input
...
var Select = _react2['default'].createClass({
	...
	render: function render() {
		...
		if (this.props.multi && !this.props.disabled && valueArray.length && !this.state.inputValue && this.props.backspaceRemoves !== false && this.state.isFocused) {
